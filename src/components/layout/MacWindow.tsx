...
export function MacWindow({ title, children, footer }: MacWindowProps) {
  return (
    <div className="fixed inset-0 flex flex-col overflow-hidden bg-white/70 backdrop-blur-xl dark:bg-black/60 md:relative md:inset-auto md:h-[95vh] md:max-w-5xl md:rounded-2xl md:border md:border-white/20 md:shadow-2xl">
