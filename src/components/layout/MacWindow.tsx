...
export function MacWindow({ title, children, footer }: MacWindowProps) {
  return (
    <div className="flex h-full w-full flex-col bg-white/70 backdrop-blur-xl dark:bg-black/60 md:h-[95vh] md:max-w-5xl md:overflow-hidden md:rounded-2xl md:border md:border-white/20 md:shadow-2xl">
