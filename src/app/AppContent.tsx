...
export function AppContent() {
  ...
  return (
    <>
      {/*
       * MacWindow (has backdrop-blur-xl) and TabBar are SIBLINGS here.
       * TabBar uses position:fixed — because it is NOT a descendant of the
       * backdrop-blur-xl element, WebKit does not trap its fixed positioning
       * inside MacWindow. It anchors directly to the viewport bottom.
       */}
      <MacWindow>
        {isLoading ? (
